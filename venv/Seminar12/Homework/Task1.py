...
if __name__ == '__main__':
    m = Student("George", "Vladislav", "Trakhtenberg", Path('lessons.csv'))
    print(m)
    m.new_estimate("Deutsch", 5)
    m.new_estimate("English", 5)
    m.new_estimate("Physics", 2)
    m.new_estimate("Physics", 4)
    m.new_estimate("Math", 4)
    m.new_estimate("Deutsch", 4)
    m.new_estimate("English", 5)
    ...
    m.new_estimate("Deutsch", 79, "test")
    m.new_estimate("Deutsch", 93, "test")
    m.new_estimate("Spanish", 95, "test")
    m.new_estimate("Spanish", 74, "test")
